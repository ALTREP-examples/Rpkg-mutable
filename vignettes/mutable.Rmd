...
- Wrapper meta-data for mutables would also be a problem.
- distinguish internally, externally mutable?
    - explicitly mutable at the R level -- probably not viable for now
    - standard R, but mutating may mutate external store (e.g. mmap)
      - should be OK
    - standard R, no mutation from R, but external mutation can happen
      - no reliable meta data possible if external mutation might happen
